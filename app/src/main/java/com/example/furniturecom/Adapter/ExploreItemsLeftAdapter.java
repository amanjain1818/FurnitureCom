...
import com.example.furniturecom.Activity.CongrtsActivity;
...
public class ExploreItemsLeftAdapter extends RecyclerView.Adapter<ExploreItemsLeftAdapter.ViewHolder> {
    Context context;
    List<ExploreItems> item1;

    public ExploreItemsLeftAdapter(Context context, List<ExploreItems> item1) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.exploreitems,parent,false);
        return new ExploreItemsLeftAdapter.ViewHolder(view);
